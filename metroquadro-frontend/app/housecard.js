...
export default function HouseCard({ id, imgSrc, price, title, numLocales, m2, bathrooms, floors, description }) {
    ...
    return (
        <Link href={parsedPath}>
            <div className={styles.houseCard} style={{backgroundImage: imgPath }} >
